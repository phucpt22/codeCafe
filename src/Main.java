...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtDis2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        jPanel7.add(jPanel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 150, 260, 150));
    ...
    public void loadDuLieuVao() {
        ...
        if (line > 0) {
            for (int i = 0; i < line; i++) {
                ...
                double tt = a * n;
                double thanhtien = arrayct.get(i).getThanhTien() + tt;
